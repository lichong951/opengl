...
public class MySurfaceView_1 extends GLSurfaceView {
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //加载要绘制的物体
            lovo_ch=LoadUtil.loadFromFileVertexOnly("ch.obj", MySurfaceView_1.this.getResources(), MySurfaceView_1.this);
            lovo_pm=LoadUtil.loadFromFileVertexOnly("pm.obj", MySurfaceView_1.this.getResources(), MySurfaceView_1.this);
            lovo_cft=LoadUtil.loadFromFileVertexOnly("cft.obj", MySurfaceView_1.this.getResources(), MySurfaceView_1.this);
            lovo_qt=LoadUtil.loadFromFileVertexOnly("qt.obj", MySurfaceView_1.this.getResources()
                    , MySurfaceView_1.this);
            lovo_yh=LoadUtil.loadFromFileVertexOnly("yh.obj", MySurfaceView_1.this.getResources(), MySurfaceView_1.this);
            //显示阴影贴图的纹理矩形
