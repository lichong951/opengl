...
public class MainActivity extends AppCompatActivity {
   ...
   public void sample15_5(View view){

        Sample15_5_Activity.actionActivity(this);
    }
   public void sample15_6(View view){

        Sample15_6_Activity.actionActivity(this);
    }
   public void sample15_7(View view){

        Sample15_7_Activity.actionActivity(this);
    }
   public void sample15_8_v1(View view){

        Sample15_8_v1_Activity.actionActivity(this);
    }
   public void sample15_8_v2(View view){
