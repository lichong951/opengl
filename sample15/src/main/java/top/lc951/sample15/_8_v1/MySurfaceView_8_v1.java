package top.lc951.sample15._8_v1;
...
import static top.lc951.sample15._8_v1.Constant.SCREEN_HEIGHT;
import static top.lc951.sample15._8_v1.Constant.SCREEN_WIDTH;
import static top.lc951.sample15._8_v1.Constant.SHADOW_TEX_HEIGHT;
import static top.lc951.sample15._8_v1.Constant.SHADOW_TEX_WIDTH;
...
public class MySurfaceView_8_v1 extends GLSurfaceView {
    ...
    public MySurfaceView_8_v1(Context context) {
        super(context);
...
//指定一个二维的纹理图片
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            MatrixState.setLightLocation(lx, ly, lz);
            //加载要绘制的物体
            lovo_ch=LoadUtil.loadFromFileVertexOnly("ch_8_v1.obj", MySurfaceView_8_v1.this.getResources(), MySurfaceView_8_v1.this);
            lovo_pm=LoadUtil.loadFromFileVertexOnly("pm_8_v1.obj", MySurfaceView_8_v1.this.getResources(), MySurfaceView_8_v1.this);
            lovo_cft=LoadUtil.loadFromFileVertexOnly("cft_8_v1.obj", MySurfaceView_8_v1.this.getResources(), MySurfaceView_8_v1.this);
            lovo_qt=LoadUtil.loadFromFileVertexOnly("qt_8_v1.obj", MySurfaceView_8_v1.this.getResources(), MySurfaceView_8_v1.this);
            lovo_yh=LoadUtil.loadFromFileVertexOnly("yh_8_v1.obj", MySurfaceView_8_v1.this.getResources(), MySurfaceView_8_v1.this);
            //显示阴影贴图的纹理矩形
            tr=new TextureRect(MySurfaceView_8_v1.this);
        }
    }
