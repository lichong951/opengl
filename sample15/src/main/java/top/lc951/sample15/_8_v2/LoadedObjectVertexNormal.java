...
class LoadedObjectVertexNormal {
    ...
    public void intShader(MySurfaceView_8_v2 mv)
    {
        ...
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("frag_8_v2.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
    ...
    public void initShaderForShadow(MySurfaceView_8_v2 mv)
    {
        ...
        //加载片元着色器的脚本内容
        mFragmentShaderForShadow=ShaderUtil.loadFromAssetsFile("frag_shadow_8_v2.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
