...
public class MySurfaceView_7 extends GLSurfaceView {
    ...
    public MySurfaceView_7(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //加载要绘制的物体
            ch=LoadUtil.loadFromFileVertexOnlyAverage("ch.obj", MySurfaceView_7.this.getResources(), MySurfaceView_7.this);
            pm=LoadUtil.loadFromFileVertexOnlyFace("pm.obj", MySurfaceView_7.this.getResources(),
                    MySurfaceView_7.this);;
            cft=LoadUtil.loadFromFileVertexOnlyFace("cft_7.obj", MySurfaceView_7.this.getResources(), MySurfaceView_7.this);;
            qt=LoadUtil.loadFromFileVertexOnlyAverage("qt.obj", MySurfaceView_7.this.getResources(), MySurfaceView_7.this);;
            yh=LoadUtil.loadFromFileVertexOnlyAverage("yh.obj", MySurfaceView_7.this.getResources(), MySurfaceView_7.this);;
        }
    }
}
