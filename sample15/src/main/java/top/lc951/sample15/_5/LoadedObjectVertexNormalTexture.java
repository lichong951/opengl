...
class LoadedObjectVertexNormalTexture {
    ...
    public LoadedObjectVertexNormalTexture(MySurfaceView_5 mv, float[] vertices, float[] normals)
    {
        //初始化顶点坐标与着色数据
    ...
    {
        //加载顶点着色器的脚本内容
        mVertexShader= ShaderUtil.loadFromAssetsFile("vertex_tex_cube_5.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("frag_tex_cube_5.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
