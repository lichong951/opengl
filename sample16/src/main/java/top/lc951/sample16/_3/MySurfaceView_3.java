...
public class MySurfaceView_3 extends GLSurfaceView {
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //加载要绘制的物体
            ch=LoadUtil.loadFromFile("ch.obj", MySurfaceView_3.this.getResources(), MySurfaceView_3.this);
            pm=LoadUtil.loadFromFile("pm.obj", MySurfaceView_3.this.getResources(), MySurfaceView_3.this);
            ...
            aList.add(new RigidBody(ch,false,new Vector3f(-8f,0f,0),new Vector3f(4,0,0)));
