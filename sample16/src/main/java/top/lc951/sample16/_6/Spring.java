...
class Spring {
    ...
    public Spring(Mass mass1, Mass mass2) {//构造器
        ...
        this.springConstant = Constant_6.springConstant;//指定弹性系数
        this.springLength = Constant_6.springLength;//指定弹簧长度
        this.frictionConstant = Constant_6.frictionConstant;//指定弹簧摩擦系数
    }
