...
public class MySurfaceView_1 extends GLSurfaceView {
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //加载要绘制的物体
            ch=LoadUtil.loadFromFile("ch.obj", MySurfaceView_1.this.getResources(), MySurfaceView_1.this);
            pm=LoadUtil.loadFromFile("pm.obj", MySurfaceView_1.this.getResources(), MySurfaceView_1.this);
