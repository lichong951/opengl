...
import top.lc951.sample6._6.MySurfaceView;

public class Sample6_6_Activity extends AppCompatActivity {
    private MySurfaceView mGLSurfaceView;
    public static void actionActivity(Context context){
        context.startActivity(new Intent(context, Sample6_6_Activity.class));
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sample6_6);
