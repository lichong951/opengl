...
import top.lc951.sample6._3.MySurfaceView;

public class Sample6_3_Activity extends AppCompatActivity {
    private MySurfaceView mGLSurfaceView;
    public static void actionActivity(Context context){
        context.startActivity(new Intent(context, Sample6_3_Activity.class));
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 切换到主界面
        setContentView(R.layout.activity_sample6_3);
