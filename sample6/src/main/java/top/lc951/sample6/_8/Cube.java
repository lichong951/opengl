...
import top.lc951.sample6._6.MatrixState;
import top.lc951.sample6.common.Constant;
import top.lc951.sample6.common.ShaderUtil;

import static top.lc951.sample6.common.Constant.UNIT_SIZE;
...
public class Cube {
    ...
    public void initShader(MySurfaceView mv) {
        // 加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("vertex_8.sh",
                mv.getResources());
        // 加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("frag_8.sh",
                mv.getResources());
        // 基于顶点着色器与片元着色器创建程序
