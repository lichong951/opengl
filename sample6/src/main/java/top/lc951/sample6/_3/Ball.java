...
import top.lc951.sample6.common.MatrixState;
...
public class Ball {
    ...
    public void initShader(MySurfaceView mv) {
        // 加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("vertex_3.sh",
                mv.getResources());
        // 加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("frag_3.sh",
                mv.getResources());
        // 基于顶点着色器与片元着色器创建程序
