...
import top.lc951.sample6._7.MySurfaceView;

public class Sample6_7_Activity extends AppCompatActivity {
    private MySurfaceView mGLSurfaceView;
    public static void actionActivity(Context context){
        context.startActivity(new Intent(context, Sample6_7_Activity.class));
    }
    @Override
...
// 设置为全屏
        ...
        // 切换到主界面
        setContentView(R.layout.activity_sample6_7);
