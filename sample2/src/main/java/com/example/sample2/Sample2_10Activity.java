...
public class Sample2_10Activity extends AppCompatActivity {
        public static void actionActivity(Context context){
            context.startActivity(new Intent(context, Sample2_10Activity.class));
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sample2_10);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case Constant.MSG_READ:
                    ...
                    Toast.makeText(Sample2_10Activity.this,
