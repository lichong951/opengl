...
public class MySurfaceView_8 extends GLSurfaceView {
    ...
    public MySurfaceView_8(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config)
        {
            ...
            //加载要绘制的物体
            lovo=LoadUtil.loadFromFile("ch_t.obj", MySurfaceView_8.this.getResources(), MySurfaceView_8.this);
            //加载纹理
