...
import top.lc951.sample8._5.MySurfaceView;

public class Sample8_5_Activity extends AppCompatActivity {
    MySurfaceView mySurfaceView;
    public static void actionActivity(Context context){
        context.startActivity(new Intent(context, Sample8_5_Activity.class));
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //切换到主界面
        setContentView(R.layout.activity_sample8_5);
