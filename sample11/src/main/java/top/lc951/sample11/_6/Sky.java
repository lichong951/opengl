...
class Sky {
    ...
    {
        String mVertexHandle= ShaderUtil.loadFromAssetsFile("vertex_6.sh", mv.getResources());
        String mTexCoorHandle=ShaderUtil.loadFromAssetsFile("frag_6.sh", mv.getResources());
