...
class Mountion {
    ...
    {
        String mVertexShader= ShaderUtil.loadFromAssetsFile("vertex_4.sh", mv.getResources());
        String mFragmentShader=ShaderUtil.loadFromAssetsFile("frag_4.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
