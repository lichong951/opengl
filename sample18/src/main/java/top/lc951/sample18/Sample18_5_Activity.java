...
public class Sample18_5_Activity extends AppCompatActivity {
    SensorManager mySensorManager;	//SensorManager对象引用
    Sensor myIsNear; 	//传感器类型
    TextView isNear;	//TextView对象引用
    TextView info;
    public static void actionActivity(Context context){
            Intent intent =new Intent(context,Sample18_5_Activity.class);
            context.startActivity(intent);
        }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sample18_5);
