...
public class MySurfaceView_6 extends GLSurfaceView {
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建各个立方体
            cubeGroup=new CubeGroup(MySurfaceView_6.this, Constant_6.SCALE,
                    Constant_6.CUBE_LENGTH, Constant_6.CUBE_HEIGHT, Constant_6.CUBE_WIDTH , Constant_6.WALL_WIDTH);//立方体组

            //创建球的对象
            ballForControl=new BallForControl(MySurfaceView_6.this, Constant_6.SCALE, Constant_6.AHALF,5);
