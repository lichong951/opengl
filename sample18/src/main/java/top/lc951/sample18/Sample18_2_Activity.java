...
public class Sample18_2_Activity extends AppCompatActivity {
    ...
    public static void actionActivity(Context context){
            Intent intent =new Intent(context,Sample18_2_Activity.class);
            context.startActivity(intent);
        }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sample18_2);
