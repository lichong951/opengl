...
import static top.lc951.basketball_shot.Constant.BANGZHU_JIEMIAN;
import static top.lc951.basketball_shot.Constant.CAIDAN_JIEMIAN;
import static top.lc951.basketball_shot.Constant.CAIDAN_RETRY;
import static top.lc951.basketball_shot.Constant.GUANYU_JIEMIAN;
import static top.lc951.basketball_shot.Constant.JIAZAI_JIEMIAN;
import static top.lc951.basketball_shot.Constant.JIESHU_JIEMIAN;
import static top.lc951.basketball_shot.Constant.JILU_JIEMIAN;
...
import static top.lc951.basketball_shot.Constant.SHENGYING_KG_JIEMIAN;
import static top.lc951.basketball_shot.Constant.YOUXI_JIEMIAN;
import static top.lc951.basketball_shot.Constant.isBJmiusic;
import static top.lc951.basketball_shot.Constant.isCJmiusic;
...
public class BasketBall_Shot_Activity extends AppCompatActivity {
            ...
            public void handleMessage(Message msg)
            {
                ...
                switch(msg.what)
                {
                    ...
                    case BANGZHU_JIEMIAN://帮助界面
                        ...
                        Constant.isnoHelpView=true;//该界面为帮助界面
    ...
    public void chushihuaScreen()
    {
        ...
        Constant.sXtart=(SCREEN_WIDHT-480*ratio_width)/2;
        Constant.sYtart=(SCREEN_HEIGHT-800*ratio_height)/2;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent e)
    {
        ...
        if(curr==WhichView.GAME_VIEW)//游戏界面
        {
            ...
            Constant.flag=false;//现场停止
            Constant.shipingJs=0;//视频现场归零
            xiaoxichuli.sendEmptyMessage(CAIDAN_RETRY);//返回到菜单界面
            return true;
        }
        return true;
