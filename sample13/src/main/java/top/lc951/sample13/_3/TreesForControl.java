...
import static top.lc951.sample13._3.Constant_3.MAP_TREE;
...
class TreesForControl {
    ...
    public TreesForControl(TreeTrunk treeTrunk,TreeLeaves[] treeLeaves)
    {
        ...
        {
            //创建所有的树干
            treeTrunkList.add(new TreeTrunkControl(Constant_3.MAP_TREE[i][0],MAP_TREE[i][1],MAP_TREE[i][2],treeTrunk));
            //创建所有的树叶
