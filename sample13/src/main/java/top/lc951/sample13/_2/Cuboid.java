...
import static top.lc951.sample13.utils.ShaderUtil.createProgram;
...
class Cuboid {
    ...
    public Cuboid(MySurfaceView_2 mv)
    {
        //初始化顶点坐标与着色数据
        initVertexData();
        //初始化shader
    ...
    {
        //加载顶点着色器的脚本内容
        mVertexShader= ShaderUtil.loadFromAssetsFile("vertex_tex_2.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("frag_tex_2.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
