...
import static top.lc951.sample13._5.Constant_5.triangle_edgeLength;
import static top.lc951.sample13._5.Constant_5.triangle_levelNum;
...
public class GameSurfaceView_5 extends GLSurfaceView {
    ...
    public GameSurfaceView_5(Context context)
    {
        super(context);
    ...
    class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config)
        {
            ...
            //加载shader
            ShaderManager.loadCodeFromFile(GameSurfaceView_5.this.getResources());
            //编译shader
