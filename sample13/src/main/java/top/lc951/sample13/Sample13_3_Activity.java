...
public class Sample13_3_Activity extends AppCompatActivity {
    ...
    public static void actionActivity(Context context){
        context.startActivity(new Intent(context, Sample13_3_Activity.class));
    }
    @Override
    ...
    public void initScreen()
    {
        ...
        //设置为横屏模式
        Constant_3.SCREEN_WIDTH=getWindowManager().getDefaultDisplay().getWidth();
        Constant_3.SCREEN_HEIGHT=getWindowManager().getDefaultDisplay().getHeight();
    }
    @Override
    ...
    public Dialog onCreateDialog(int id)
    {
        ...
        {
            case 0://生成普通对话框的代码
                String msg="当前的风向为: "+Constant_3.wind_direction+" 度";
                ...
                sb.setMax(359);
                sb.setProgress((int)Constant_3.wind_direction);
                sb.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener()
                {
                    ...
                    public void onProgressChanged(SeekBar seekBar, int progress,
                                                  boolean fromUser)
                    {
                        Constant_3.wind_direction=sb.getProgress();
            ...
            case 1://生成普通对话框的代码
                ...
                sb1.setMax(12);
                sb1.setProgress(Constant_3.wind);
                sb1.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener()
                {
                    ...
                    public void onProgressChanged(SeekBar seekBar, int progress,
                                                  boolean fromUser)
                    {
                        Constant_3.setWindForce(sb1.getProgress());
