...
class GledeForDraw {
    ...
    public GledeForDraw(MySurfaceView_4 mv)
    {
        //初始化顶点坐标与着色数据
        initVertexData(mv);
        //初始化shader
    ...
    //初始化顶点坐标与着色数据的方法
    public void initVertexData(MySurfaceView_4 mv)
    {
    ...
    {
        //加载顶点着色器的脚本内容
        mVertexShader= ShaderUtil.loadFromAssetsFile("vertex_4.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("frag_4.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
