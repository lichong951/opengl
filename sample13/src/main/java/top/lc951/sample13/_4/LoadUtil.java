...
import static top.lc951.sample13._4.Constant_4.MAX_S_GHXP;
import static top.lc951.sample13._4.Constant_4.MAX_T_GHXP;
...
class LoadUtil {
    ...
    public static float[][] loadFromFileVertexOnly(String fname, MySurfaceView_4 mv)
    {
