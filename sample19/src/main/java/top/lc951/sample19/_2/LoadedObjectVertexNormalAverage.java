...
import top.lc951.sample19.utils.ShaderUtil;
...
class LoadedObjectVertexNormalAverage {
    ...
    public LoadedObjectVertexNormalAverage(MySurfaceView_2 mv, float[] vertices, float[] normals)
    {
        //初始化顶点坐标与着色数据
    ...
    public void initShader(MySurfaceView_2 mv)
    {
        ...
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("frag_1.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
