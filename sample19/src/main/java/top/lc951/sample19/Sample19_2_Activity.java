...
import top.lc951.sample19._2.MySurfaceView_2;

public class Sample19_2_Activity extends AppCompatActivity {

    private MySurfaceView_2 mGLSurfaceView;
    public static float screenWidth;//屏幕宽度
    public static float screenHeight;//屏幕高度
    public static void actionActivity(Context context){
        context.startActivity(new Intent(context, Sample19_2_Activity.class));
    }
    @Override
