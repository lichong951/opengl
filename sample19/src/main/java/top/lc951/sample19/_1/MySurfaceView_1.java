...
import top.lc951.sample19.Sample19_1_Activity;
...
public class MySurfaceView_1 extends GLSurfaceView{
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //加载要绘制的物体
            pm=LoadUtil.loadFromFileVertexOnlyFace("pm.obj", MySurfaceView_1.this.getResources(), MySurfaceView_1.this);

            ch=LoadUtil.loadFromFileVertexOnlyAverage("ch.obj", MySurfaceView_1.this.getResources(), MySurfaceView_1.this);
            cft=LoadUtil.loadFromFileVertexOnlyFace("cft.obj", MySurfaceView_1.this.getResources(), MySurfaceView_1.this);
            qt=LoadUtil.loadFromFileVertexOnlyAverage("qt.obj", MySurfaceView_1.this.getResources(), MySurfaceView_1.this);
            yh=LoadUtil.loadFromFileVertexOnlyAverage("yh.obj", MySurfaceView_1.this.getResources
                    (), MySurfaceView_1.this);
            lovnList.add(ch);
            lovnList.add(cft);
            lovnList.add(qt);
            lovnList.add(yh);
