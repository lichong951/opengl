...
import top.lc951.sample19._1.MySurfaceView_1;

public class Sample19_1_Activity extends AppCompatActivity {
    private MySurfaceView_1 mGLSurfaceView;
    public static float screenWidth;//屏幕宽度
    public static float screenHeight;//屏幕高度

    public static void actionActivity(Context context) {
        context.startActivity(new Intent(context, Sample19_1_Activity.class));
    }
