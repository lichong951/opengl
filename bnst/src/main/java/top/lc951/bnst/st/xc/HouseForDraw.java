...
import static top.lc951.bnst.st.xc.Constant_xc.HOUSE_COLOR;
import static top.lc951.bnst.st.xc.Constant_xc.WALL_HEIGHT;
...
public class HouseForDraw {
    ...
    {
        //创建地面
        floor=new TextureRect(ShaderManager_xc.getCommTextureShaderProgram(),floorWidth,floorHeight);
        //创建围墙
        wall=new ColorLightRect(ShaderManager_xc.getColorshaderProgram(),wallWidth,wallHeight,HOUSE_COLOR[1]);
        //创建放置广告的纹理墙
        wall_tex=new TextureRect(ShaderManager_xc.getCommTextureShaderProgram(),wallWidth,wallHeight);
    }
    //绘制地板的方法
