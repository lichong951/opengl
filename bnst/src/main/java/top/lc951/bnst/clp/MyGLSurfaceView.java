...
import static top.lc951.bnst.clp.Constant_clp.BOAT_A;
import static top.lc951.bnst.clp.Constant_clp.BOAT_A_PAUSE;
import static top.lc951.bnst.clp.Constant_clp.CAMERA_INI_Y;
import static top.lc951.bnst.clp.Constant_clp.COLS;
import static top.lc951.bnst.clp.Constant_clp.CURR_BOAT_V;
import static top.lc951.bnst.clp.Constant_clp.CURR_BOAT_V_PAUSE;
import static top.lc951.bnst.clp.Constant_clp.DIRECTION_INI;
import static top.lc951.bnst.clp.Constant_clp.DISTANCE;
import static top.lc951.bnst.clp.Constant_clp.LAND_MAX_HIGHEST;
import static top.lc951.bnst.clp.Constant_clp.MAP_ARRAY;
import static top.lc951.bnst.clp.Constant_clp.Max_BOAT_V_FINAL;
import static top.lc951.bnst.clp.Constant_clp.NUMBER_MAP;
import static top.lc951.bnst.clp.Constant_clp.ROWS;
import static top.lc951.bnst.clp.Constant_clp.Radar_Ratio;
import static top.lc951.bnst.clp.Constant_clp.Self_Adapter_Data_HSJ_XY;
import static top.lc951.bnst.clp.Constant_clp.Self_Adapter_Data_ON_TOUCH;
import static top.lc951.bnst.clp.Constant_clp.Self_Adapter_Data_TRASLATE;
import static top.lc951.bnst.clp.Constant_clp.SoundEffectFlag;
import static top.lc951.bnst.clp.Constant_clp.UNIT_SIZE;
import static top.lc951.bnst.clp.Constant_clp.YACHT_INI_X;
import static top.lc951.bnst.clp.Constant_clp.YACHT_INI_Z;
import static top.lc951.bnst.clp.Constant_clp.directNo;
import static top.lc951.bnst.clp.Constant_clp.gameTimeUse;
import static top.lc951.bnst.clp.Constant_clp.getDirectionNumber;
import static top.lc951.bnst.clp.Constant_clp.isOpenHSJ;
import static top.lc951.bnst.clp.Constant_clp.isPaused;
import static top.lc951.bnst.clp.Constant_clp.isSpeedMode;
import static top.lc951.bnst.clp.Constant_clp.lockA;
import static top.lc951.bnst.clp.Constant_clp.numberOfN2;
import static top.lc951.bnst.clp.Constant_clp.numberOfTurns;
import static top.lc951.bnst.clp.Constant_clp.screenId;
import static top.lc951.bnst.clp.Constant_clp.yArray_WD;
import static top.lc951.bnst.clp.Constant_clp.yArray_ZD;
import static top.lc951.bnst.clp.Constant_clp.yArray_ZD_DXD;
import static top.lc951.bnst.clp.KEatData.KEAT_ARRAY;
import static top.lc951.bnst.clp.KZBJData.KZBJ_ARRAY;
import static top.lc951.bnst.clp.TDObjectData.PART_LIST;
import static top.lc951.bnst.clp.TreeData.Tree_Data;
...
public class MyGLSurfaceView extends GLSurfaceView {
    ...
    public boolean onTouchEvent(MotionEvent e)
    {
        float x=e.getX();
        float y=e.getY();
        float yRatio=y/top.lc951.bnst.st.xc.Constant_xc.SCREEN_HEIGHT;
        float xRatio=x/top.lc951.bnst.st.xc.Constant_xc.SCREEN_WIDTH;
        switch(e.getAction())
        {
                ...
                if(isAllowToClick)
                {
                            ...
                            )
                    {
                        if(numberOfN2>0)
                        {
                            ...
                            Constant_clp.Max_BOAT_V=Max_BOAT_V_FINAL;
                            kt.dqCount=80;
                        }
                        else
                        {
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        int djsTexId;
        //雷达底图的绘制者
        top.lc951.bnst.st.xc.TextureRect radar_Background;
        //雷达指针的绘制者
        top.lc951.bnst.st.xc.TextureRect radar_Zhizhen;
        //雷达中其他船的绘制者
        top.lc951.bnst.st.xc.TextureRect other_Radar_Zhizhen;
        //后视镜的绘制者
        top.lc951.bnst.st.xc.TextureRect houshijing;
        //后视镜纹理ID
        int houshijingTexId;
        ...
        public void drawStartAndEnd(int currOfTurns,int dyFlag)
        {
            ...
            if(currOfTurns==1&&!Constant_clp.halfFlag)//刚开始
            {
                gameStartAndEnd.drawSelf(ggSzTexId,gameStartTexId,LAND_MAX_HIGHEST-5,dyFlag);
            }
            else if(currOfTurns==2&& Constant_clp.halfFlag)
            {
        ...
        public void readLoadTask()
        {
                ...
                bndrawer=new BNDrawer[]
                        {
                                ...
                                new Tunnel						//隧道
                                        (
                                                ...
                                                Constant_clp.yArray_Tunnel,
                                                Constant_clp.yArray_Tunnel.length-1,
                                                Constant_clp.yArray_Tunnel[0].length-1
                                        ),
                                new Mountion					//山
                                        (
                                                ShaderManager.getMountionShaderProgram(),
                                                Constant_clp.yArray_Mountion,
                                                Constant_clp.yArray_Mountion.length-1,
                                                Constant_clp.yArray_Mountion[0].length-1
                                        ),
            ...
            else if(step==6)
            {
                ...
                //后视镜边框
                houshijing=new top.lc951.bnst.st.xc.TextureRect(ShaderManager.getTextureShaderProgram(),Self_Adapter_Data_HSJ_XY[screenId][3],Self_Adapter_Data_HSJ_XY[screenId][4]);
            ...
            else if(step==8)
            {
                ...
                if(isSpeedMode)
                {
                    ...
                    radar_Background=new top.lc951.bnst.st.xc.TextureRect(ShaderManager.getTextureShaderProgram(),Self_Adapter_Data_TRASLATE[screenId][14],0.3f);
                    radar_Zhizhen=new top.lc951.bnst.st.xc.TextureRect(ShaderManager.getTextureShaderProgram(),Self_Adapter_Data_TRASLATE[screenId][14]*0.167f,0.05f);
                    other_Radar_Zhizhen=new top.lc951.bnst.st.xc.TextureRect(ShaderManager.getTextureShaderProgram(),Self_Adapter_Data_TRASLATE[screenId][14]*0.067f,0.02f);
                }
                curr_process=8*(step+1);
                pgs_fgt.percent=0.0833f*(step+1);
                step++;
