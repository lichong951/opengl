...
import static top.lc951.bnst.clp.MyGLSurfaceView.yachtLeftOrRightAngleValue;
    ...
    class DJSThread extends Thread
    {
        ...
        public void run()
        {
            while(DAOJISHI_FLAG)
            {
                ...
                {
                    DAOJISHI_FLAG=false;
                    MyGLSurfaceView.isJiShi=true;
                    MyGLSurfaceView.isAllowToClick=true;
                    Constant_clp. DEGREE_SPAN=2.5f;
                    Constant_clp. BOAT_A=0.025f;
