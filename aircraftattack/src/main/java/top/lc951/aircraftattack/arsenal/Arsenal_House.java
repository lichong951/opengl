...
import static top.lc951.aircraftattack.game_view.Constant.Lock_arsenal;
...
public class Arsenal_House {
    ...
    public int blood= Constant.arsenal_blood;//血
    ...
    {//根据摄像机位置计算焰火粒子面朝向
        ...
        if(cosa<Lock_angle){
            ...
            Constant.nx=x1;Constant.ny=y1+ARSENAL_Y/3;Constant.nz=z1;//发射子弹方向向量
            Constant.isno_Lock=true;//已经被锁定
            Lock_arsenal=this;
        }else{
            this_isno_Lock=false;
        }
