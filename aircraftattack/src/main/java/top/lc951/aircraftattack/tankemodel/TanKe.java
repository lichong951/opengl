package top.lc951.aircraftattack.tankemodel;
...
import static top.lc951.aircraftattack.game_view.Constant.Lock_tanke;
...
import static top.lc951.aircraftattack.game_view.Constant.TANK_MAX_DISTANCE;
...
import static top.lc951.aircraftattack.game_view.Constant.tank_ratio;
...
public class TanKe {
    ...
    {//根据摄像机位置计算焰火粒子面朝向
        ...
        if(cosa<Lock_angle)
        {
            ...
            Constant.nx=x1;Constant.ny=y1+20;Constant.nz=z1;//发射子弹方向向量
