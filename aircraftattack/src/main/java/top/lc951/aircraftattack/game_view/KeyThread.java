package top.lc951.aircraftattack.game_view;

import java.util.Collections;
import java.util.Date;

import top.lc951.aircraftattack.arsenal.Arsenal_House;
import top.lc951.aircraftattack.commonObject.DrawBomb;
import top.lc951.aircraftattack.commonObject.Tree;
import top.lc951.aircraftattack.core.SQLiteUtil;

import static top.lc951.aircraftattack.game_view.Constant.ABOUT_HEIGHT;
import static top.lc951.aircraftattack.game_view.Constant.ANGLE_X_Z;
import static top.lc951.aircraftattack.game_view.Constant.ARSENAL_X;
import static top.lc951.aircraftattack.game_view.Constant.ARSENAL_Y;
import static top.lc951.aircraftattack.game_view.Constant.ARSENAL_Z;
import static top.lc951.aircraftattack.game_view.Constant.ArchieArray;
import static top.lc951.aircraftattack.game_view.Constant.BUTTON_RADAR_BG_WIDTH;
import static top.lc951.aircraftattack.game_view.Constant.BaoZha_scal;
import static top.lc951.aircraftattack.game_view.Constant.Crash_DISTANCE_start;
import static top.lc951.aircraftattack.game_view.Constant.Crash_DISTANCE_stop;
import static top.lc951.aircraftattack.game_view.Constant.DIRECTION_CAMERA;
import static top.lc951.aircraftattack.game_view.Constant.DIRECTION_CAMERA_SPAN;
import static top.lc951.aircraftattack.game_view.Constant.DISTANCE;
import static top.lc951.aircraftattack.game_view.Constant.ELEVATION_CAMERA;
import static top.lc951.aircraftattack.game_view.Constant.ELEVATION_CAMERA_DOWN;
import static top.lc951.aircraftattack.game_view.Constant.ELEVATION_CAMERA_ORI;
import static top.lc951.aircraftattack.game_view.Constant.ELEVATION_CAMERA_SPAN;
import static top.lc951.aircraftattack.game_view.Constant.ELEVATION_CAMERA_UP;
import static top.lc951.aircraftattack.game_view.Constant.HELP_HEIGHT;
import static top.lc951.aircraftattack.game_view.Constant.LANDS_HEIGHT_ARRAY;
import static top.lc951.aircraftattack.game_view.Constant.LAND_HIGHEST;
import static top.lc951.aircraftattack.game_view.Constant.LAND_UNIT_SIZE;
import static top.lc951.aircraftattack.game_view.Constant.Lock_Distance;
import static top.lc951.aircraftattack.game_view.Constant.MapArray;
import static top.lc951.aircraftattack.game_view.Constant.PLANE_DOWN_ROTATION_DOMAIN_X;
import static top.lc951.aircraftattack.game_view.Constant.PLANE_HEIGHT_MAX;
import static top.lc951.aircraftattack.game_view.Constant.PLANE_MOVE_SPAN;
import static top.lc951.aircraftattack.game_view.Constant.PLANE_ROTATION_SPEED_SPAN_X;
import static top.lc951.aircraftattack.game_view.Constant.PLANE_ROTATION_SPEED_SPAN_Z;
import static top.lc951.aircraftattack.game_view.Constant.PLANE_UP_ROTATION_DOMAIN_X;
import static top.lc951.aircraftattack.game_view.Constant.PLANE_X;
import static top.lc951.aircraftattack.game_view.Constant.PLANE_X_R;
import static top.lc951.aircraftattack.game_view.Constant.PLANE_Y;
import static top.lc951.aircraftattack.game_view.Constant.PLANE_Y_R;
import static top.lc951.aircraftattack.game_view.Constant.PLANE_Z;
import static top.lc951.aircraftattack.game_view.Constant.TRANSFER_Y;
import static top.lc951.aircraftattack.game_view.Constant.WATER_HEIGHT;
import static top.lc951.aircraftattack.game_view.Constant.WEAPON_INDEX;
import static top.lc951.aircraftattack.game_view.Constant.WIDTH_LALNDFORM;
import static top.lc951.aircraftattack.game_view.Constant.archie_List;
import static top.lc951.aircraftattack.game_view.Constant.archie_bomb_List;
import static top.lc951.aircraftattack.game_view.Constant.bomb_List;
import static top.lc951.aircraftattack.game_view.Constant.bomb_number;
import static top.lc951.aircraftattack.game_view.Constant.bullet_List;
import static top.lc951.aircraftattack.game_view.Constant.bullet_number;
import static top.lc951.aircraftattack.game_view.Constant.fire_index;
import static top.lc951.aircraftattack.game_view.Constant.gradeArray;
import static top.lc951.aircraftattack.game_view.Constant.house_height;
import static top.lc951.aircraftattack.game_view.Constant.house_length;
import static top.lc951.aircraftattack.game_view.Constant.house_width;
import static top.lc951.aircraftattack.game_view.Constant.isCrash;
import static top.lc951.aircraftattack.game_view.Constant.isFireOn;
import static top.lc951.aircraftattack.game_view.Constant.isOvercome;
import static top.lc951.aircraftattack.game_view.Constant.isVideo;
import static top.lc951.aircraftattack.game_view.Constant.is_button_return;
import static top.lc951.aircraftattack.game_view.Constant.isno_Lock;
import static top.lc951.aircraftattack.game_view.Constant.keyState;
import static top.lc951.aircraftattack.game_view.Constant.lock;
import static top.lc951.aircraftattack.game_view.Constant.mapId;
import static top.lc951.aircraftattack.game_view.Constant.nx;
import static top.lc951.aircraftattack.game_view.Constant.ny;
import static top.lc951.aircraftattack.game_view.Constant.nz;
import static top.lc951.aircraftattack.game_view.Constant.rotationAngle_Plane_X;
import static top.lc951.aircraftattack.game_view.Constant.rotationAngle_Plane_Y;
import static top.lc951.aircraftattack.game_view.Constant.rotationAngle_Plane_Z;
import static top.lc951.aircraftattack.game_view.Constant.scalMark;
import static top.lc951.aircraftattack.game_view.Constant.tank_bomb_List;
import static top.lc951.aircraftattack.game_view.GLGameView.arsenal;
import static top.lc951.aircraftattack.game_view.GLGameView.baoZhaList;
import static top.lc951.aircraftattack.game_view.GLGameView.bombRect;
import static top.lc951.aircraftattack.game_view.GLGameView.bombRectr;
import static top.lc951.aircraftattack.game_view.GLGameView.cop_archie_List;
import static top.lc951.aircraftattack.game_view.GLGameView.cop_archie_bomb_List;
import static top.lc951.aircraftattack.game_view.GLGameView.cop_bomb_List;
import static top.lc951.aircraftattack.game_view.GLGameView.cop_bullet_List;
import static top.lc951.aircraftattack.game_view.GLGameView.enemy;
import static top.lc951.aircraftattack.game_view.GLGameView.isVideoPlaying;
import static top.lc951.aircraftattack.game_view.GLGameView.tankeList;
import static top.lc951.aircraftattack.game_view.GLGameView.treeList;
import static top.lc951.aircraftattack.game_view.GLGameView.tx;
import static top.lc951.aircraftattack.game_view.GLGameView.ty;
import static top.lc951.aircraftattack.game_view.GLGameView.tz;
...
public class KeyThread extends Thread{
        ...
        while(flag_go)
        {
            if(gv.isGameOn)//如果游戏开始
            {
                synchronized(lock)
                {
                    ...
                    //=====特别行动时记录时间
                    if(gv.isGameMode==1&&!Constant.is_button_return&&!isVideo&&System.nanoTime()-gv.oldTime>1000000000)
                    {
                        gv.goTime--;
                    ...
                    if(isCrash)//如果飞机坠毁
                    {
                        ...
                        new Thread()
                        {
                            ...
                            public void run()
                            {
                                Constant.isno_draw_arsenal=false;//不绘制军火库
                                while(time<15000)
                                {
                                    time+=50;
                                    ...
                                    {
                                        ELEVATION_CAMERA=30;
                                        GLGameView.cx=(float)(tx+Math.cos(Math.toRadians(ELEVATION_CAMERA))*Math.sin(Math.toRadians(DIRECTION_CAMERA))*Crash_DISTANCE_start);//摄像机x坐标
                                        GLGameView. cz=(float)(tz+Math.cos(Math.toRadians(ELEVATION_CAMERA))*Math.cos(Math.toRadians(DIRECTION_CAMERA))*Crash_DISTANCE_start);//摄像机z坐标
                                        GLGameView.cy=(float)(ty+Math.sin(Math.toRadians(ELEVATION_CAMERA))*Crash_DISTANCE_start);//摄像机y坐标
                                    ...
                                    else if(isnoStart&&time-thistime>2000&&time-thistime<=5500)//播放最后大爆炸
                                    {
                                        ...
                                        {
                                            Constant.isno_draw_plane=false;//不会做飞机
                                            Constant.isno_draw_arsenal=false;//不绘制军火库
                                            if(time%100==0){
                                                BaoZha_scal-=3.5f;
                                                if(BaoZha_scal<0){
                                        ...
                                        {
                                            Constant.isCrashCartoonOver=true;//动画播放完毕
                                            Constant.isno_draw_plane=false;//不绘制飞机
                    ...
                    Constant.planezAngle+=10;//飞机螺旋机转动角度
                    Constant.planezAngle%=360;
                    //飞机向前行驶,确定飞机的位置
                    ...
                    //天空穹旋转角度
                    Constant.rotationAngle_SkyBall+=0.1f;
                    //这里计算雷达指针的旋转角度
                    Constant.RADAR_DIRECTION=rotationAngle_Plane_Y;
                    //重新计算摄像机的位置
                    tx=PLANE_X;
                    ty=PLANE_Y;
                    tz=PLANE_Z;
                    GLGameView.cx=(float)(tx+Math.cos(Math.toRadians(ELEVATION_CAMERA))*Math.sin(Math.toRadians(DIRECTION_CAMERA))*DISTANCE);//摄像机x坐标
                    GLGameView.cz=(float)(tz+Math.cos(Math.toRadians(ELEVATION_CAMERA))*Math.cos(Math.toRadians(DIRECTION_CAMERA))*DISTANCE);//摄像机z坐标
                    GLGameView. cy=(float)(ty+Math.sin(Math.toRadians(ELEVATION_CAMERA))*DISTANCE);//摄像机y坐标
                    //计算标记飞机位置的坐标
                    ...
                    if(!isVideo){//如果是视频播放界面则不对其进行模拟
                        ...
                        Constant.minimumdistance=Lock_Distance;//距离跳到最大
                        isno_Lock=false;//已经有东西被锁定标志置为false
                        //飞机飞行的方向向量
                        Constant.directionX=-(float) (Math.cos(Math.toRadians(rotationAngle_Plane_X))*Math.sin(Math.toRadians(rotationAngle_Plane_Y)));
                        Constant.directionY=(float) (Math.sin(Math.toRadians(rotationAngle_Plane_X)));
                        Constant.directionZ=-(float) (Math.cos(Math.toRadians(rotationAngle_Plane_X))*Math.cos(Math.toRadians(rotationAngle_Plane_Y)));
            ...
            else//-----------------菜单界面-------------------------------
            {
                ...
                if(gv.menu_button_move)
                {
                    ...
                    if(gv.menu_button_XOffset>Constant.MENU_BUTTON_WIDTH/2+gv.ratio)
                    {
                ...
                if(gv.doorState==2&&gv.curr_menu_index==4)
                {
                    ...
                    if(gv.about_YOffset+ABOUT_HEIGHT/2<-1)
                    {
                        gv.about_YOffset=1+Constant.ABOUT_HEIGHT/2;
                    }
                }
                //当处于选择飞机场景中时
                if(2==gv.isMenuLevel)
    ...
    public  boolean isYachtHeadCollectionsWithLand(float ctx,float ctyh,float ctz)
    {
        ...
        try
        {
            ...
            float yArray[][]= LANDS_HEIGHT_ARRAY[mapArrayId];//根据模块Id得出该模块的Y轴数组
