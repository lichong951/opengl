package top.lc951.aircraftattack;
...
import top.lc951.aircraftattack.core.RotateUtil;
...
import top.lc951.aircraftattack.menu.MyVideoView;
...
import static top.lc951.aircraftattack.game_view.Constant.isMusicOn;
import static top.lc951.aircraftattack.game_view.Constant.isOvercome;
import static top.lc951.aircraftattack.game_view.Constant.isSoundOn;
import static top.lc951.aircraftattack.game_view.Constant.isVibrateOn;
...
public class Aircraft_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (flag == 0)//打开旋转屏
        {
            Settings.System.putInt(this.getContentResolver(), Settings.System
    ...
    public void initScreen() {
        ...
        Constant.ratio_width = SCREEN_WIDTH / 800;
        Constant.ratio_height = SCREEN_HEIGHT / 480;
    }

    public void initDatebase() {
        String sql = "create table if not exists plane(map char(2),grade char(4),time char(4)," +
                "date char(10));";
    ...
    public void goTo_StartVideo() { //游戏开始首先播放视频
        ...
        myVideoView.setVideoURI(Uri.parse("android.resource://top.lc951.aircraftattack/" + R.raw.logo));
        myVideoView.start();
