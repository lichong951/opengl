...
import top.lc951.aircraftattack.commonObject.NumberForDraw;
import top.lc951.aircraftattack.commonObject.TextureRect;
import top.lc951.aircraftattack.core.MatrixState;
import top.lc951.aircraftattack.game_view.BombForControl;
import top.lc951.aircraftattack.game_view.Constant;
import top.lc951.aircraftattack.game_view.GLGameView;

import static top.lc951.aircraftattack.game_view.Constant.ARCHIE_MAX_DISTANCE;
import static top.lc951.aircraftattack.game_view.Constant.BUTTON_RADAR_BG_WIDTH;
import static top.lc951.aircraftattack.game_view.Constant.Lock_Arch;
import static top.lc951.aircraftattack.game_view.Constant.Lock_angle;
...
import static top.lc951.aircraftattack.game_view.Constant.barbette_length;
import static top.lc951.aircraftattack.game_view.Constant.barrel_length;
import static top.lc951.aircraftattack.game_view.Constant.barrel_radius;
import static top.lc951.aircraftattack.game_view.Constant.cube_height;
import static top.lc951.aircraftattack.game_view.Constant.cube_length;
import static top.lc951.aircraftattack.game_view.Constant.directionX;
import static top.lc951.aircraftattack.game_view.Constant.directionY;
import static top.lc951.aircraftattack.game_view.Constant.directionZ;
...
import static top.lc951.aircraftattack.game_view.Constant.minimumdistance;
...
public class ArchieForControl {
    ...
    {//根据摄像机位置计算焰火粒子面朝向
        ...
        if(cosa<Lock_angle){
            ...
            Constant.nx=x1;Constant.ny=y1+10;Constant.nz=z1;//发射子弹方向向量
