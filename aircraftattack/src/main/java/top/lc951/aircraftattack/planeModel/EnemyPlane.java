package top.lc951.aircraftattack.planeModel;
...
import top.lc951.aircraftattack.game_view.BulletForControl;
...
import static top.lc951.aircraftattack.game_view.Constant.ENEMYPLANE_SPAN;
...
import static top.lc951.aircraftattack.game_view.Constant.PLANE_RATIO;
...
import static top.lc951.aircraftattack.game_view.Constant.enemy_plane_place;
...
public class EnemyPlane {
    ...
    {//根据摄像机位置计算焰火粒子面朝向
        ...
        if(cosa<Lock_angle){
            ...
            Constant.minimumdistance=distance1;//最小距离设置为该距离
