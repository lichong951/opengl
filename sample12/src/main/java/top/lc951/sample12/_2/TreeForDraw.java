...
class TreeForDraw {
    ...
    {
        //加载顶点着色器的脚本内容
        String mVertexShader= ShaderUtil.loadFromAssetsFile("vertex_2.sh", mv.getResources());
        //加载片元着色器的脚本内容
        String mFragmentShader=ShaderUtil.loadFromAssetsFile("frag_2.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
